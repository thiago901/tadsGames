...
<html>
    ...
    <body>
        ...
        <div class="cards">
            ...
            <div class="alternar">
                <button class="btnAlternar" id="btnFaturamentoTotal">Faturamento Total</button>
                <button class="btnAlternar" id="btnTop10Consolidado">Top 10 Consolidado</button>
            </div>
                    ...
                    <tbody>
                        <c:forEach items="${relatorioDiario}" var="r">
                            <tr class="contentTable">
                                ...
                                <td class="percentual"><a href="${pageContext.request.contextPath}/tads/inputRelatorios?action=RelDiarioTopEmpresa&top10DetalheEmpresa=${r.getIdEmpresa()}"><img class="icon" src="../img/add.png"></a></td>
                            </tr>
                        </c:forEach>
            ...
            <div  class="card cardRelatorio1" hidden="">
            ...
            <a href="${pageContext.request.contextPath}/home"><button class="btnCadastrarVenda voltaMenu" type="button">Voltar ao Menu</button></a>
                ...
                <c:import url="detalhePorEmpresa.jsp"/>
    </div>

    <script src="../javaScript/relatorioDiario.js"></script>
